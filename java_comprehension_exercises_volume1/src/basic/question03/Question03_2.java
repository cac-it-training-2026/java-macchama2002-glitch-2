...
public class Question03_2 {
	...
	public static void main(String[] args) {
		...
		int rediceTickets = --tickets;
		int totalPrice = reducedPrice * rediceTickets;

		double taxRate = 1.1;

		int totalWithTax = (int) (totalPrice * taxRate);

		System.out.println("購入可能枚数は" + rediceTickets + "枚です。");
		System.out.println("値下げ後の一枚あたりの料金は" + reducedPrice + "円です。");
